...
const DEFAULT_W = Number(process.env.OUTPUT_W) || 1280;
const DEFAULT_H = Number(process.env.OUTPUT_H) || 720;
...
function motionFilter(motion, durSec, fps, W = DEFAULT_W, H = DEFAULT_H) {
  ...
  // avoid large internal upscales — operate at target resolution
